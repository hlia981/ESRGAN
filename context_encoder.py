...
dataloader = DataLoader(
    ImageDataset(r"C:/Users/hlia981/Downloads/Linnaeus 5 256X256/Linnaeus 5 256X256/train/dog", transforms_=transforms_),
    batch_size=batch_size,
    shuffle=True,
    num_workers=n_cpu,
)
test_dataloader = DataLoader(
    ImageDataset(r"C:/Users/hlia981/Downloads/Linnaeus 5 256X256/Linnaeus 5 256X256/test/dog", transforms_=transforms_, mode="val"),
    batch_size=12,
    shuffle=True,
    num_workers=1,
)
